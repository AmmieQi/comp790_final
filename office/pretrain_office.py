...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_path", type = str, default = '../data/Office31')
    ...
    data_path = os.path.join(args.data_path, args.data_type, 'images')
    data_train, data_val, data_test = data_utils.get_dataloaders(data_path, args.data_type)
    data_train = DataLoader(data_train, batch_size = args.batch_size, shuffle = True, num_workers = args.num_workers)
    data_val = DataLoader(data_val, batch_size = args.batch_size, shuffle = False, num_workers = args.num_workers)
    data_test = DataLoader(data_test, batch_size = args.batch_size, shuffle = False, num_workers = args.num_workers)
    ...
    classifier = torch.nn.Linear(2048, 31)
